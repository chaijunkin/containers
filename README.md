...
Welcome to my container images, if looking for a container start by [browsing the GitHub Packages page for this repo's packages](https://github.com/chaijunkin?tab=packages&repo_name=containers).
...
services:
  sonarr:
    image: ghcr.io/chaijunkin/sonarr:3.0.8.1507
